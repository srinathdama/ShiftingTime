...
err_df_krno = pd.read_pickle(CURR_DIR / "err_time_dict.pkl")
...
err_df_fno3d = pd.read_pickle(os.path.join(root_base_path, "scripts/shallow-water_fno_3d/err_time_dict.pkl"))
...
err_df_loca = pd.read_pickle(CURR_DIR / "err_time_dict_loca.pkl")
...
PlotConfig.save_fig(fig, str(FIG_DIR / "krno_fno3d_loca"))
