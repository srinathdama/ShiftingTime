...
def run_exp(args, run_i=0, train_loss_optimal=None):
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            _, _, _, _, _, val_train_loss_min = exp.train(setting, train_loader, test_loader,
                                                        vali_loader=vali_loader, train_loss_optimal=train_loss_optimal)
            ...
            # plot train and valid results using the best model based on validation error
            fig1, ax1, train_results_best_window = exp.test_full_len(setting, test=1, flag='train')
            if train_loss_optimal is None:
            ...
            return [[train_results_best, val_results_best, test_results_best],
                     [train_results_best_window, val_results_best_window, test_results_best_window], val_train_loss_min]
    else:
        ii = 0
