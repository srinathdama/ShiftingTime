...
def run_exp(args, run_i=0, train_loss_optimal=None):
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            _, val_loss_min  = exp.train(setting, train_loader, test_loader, vali_loader)
        ...
        return final_model_metrics, best_model_metrics, val_loss_min
    else:
        ii = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_id', type=int, default=0, help='exp run id')
